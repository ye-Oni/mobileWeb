/* 마커 클러스터링(MarkerClustering.js) 파일 가져오기
     1) github.com/navermaps/marker-tools.js/
     2) marker-clustering>src>MarkerClustering.js->Raw->소스 복사-> MarkerClustering.js에 붙여넣기
     3) views>index.ejs에 script 선언(<script src="./js/MarkerClustering.js"></script>)
     4) js>main.js에서 마커 클러스터링을 위한 코드 작성
*/
